...
- [/] **Banner Tasarımı:** Kullanıcı daha sade ve minimalist (SpoofDPI tarzı) bir tasarım istedi. (Rate Limit nedeniyle beklemede)
- [x] **Force Refresh:** Analiz sonuçlarını önbellekten değil, yeniden Gemini'den çekmek için "Yeniden Analiz" seçeneği eklendi.
- [x] **💬 Chat with Code:** Kullanıcının repo hakkında soru sormasını sağlayan chat arayüzü eklendi.
- [x] **🏅 Badge Sistemi:** README'ye eklenebilir skor rozeti (Markdown) eklendi.
